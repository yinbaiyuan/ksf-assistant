...
require(runtime['version'] == manifest['version'] == '1.0.93-ksfassistant.1', 'managed version mismatch')
require(runtime['upstreamVersion'] == skills['version'] == '1.0.93', 'upstream provenance version mismatch')
