...
`0.11.0-preview.16` 的发布边界、兼容入口和实机门槛见 [本机预览改造](architecture/preview-0.11.md)。本机预览使用 `bash scripts/package-preview.sh --mac` 冻结当前工作树；不要为了运行公共发布脚本而暂存、提交或用 HEAD 冒充新源码。产品与受管 lark-cli 的版本规则见 [版本管理](architecture/versioning.md)。
