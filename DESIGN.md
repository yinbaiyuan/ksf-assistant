...
The app should feel like a system instrument: compact, quiet, and precise. Its audience is a KSF team member switching among projects while monitoring capacity and whether Codex needs attention. macOS follows AppKit/SwiftUI conventions and Windows follows Windows 11 tray-flyout and Fluent conventions. Both keep the same information hierarchy without forcing identical pixels. Exclude marketing surfaces, custom brand illustration, decorative gradients, and dashboard-like chrome.
