...
func TestTaskLinkCardExposesFrozenControlsByState(t *testing.T) {
	link := TaskLink{ID: "LINK-0123456789ABCDEF", TaskKey: "0123456789abcdef0123", Title: "迁移任务", ProjectName: "CodexAssistant", LinkState: "active", TurnState: "running", TurnOwner: "bridge", Phase: "执行"}
...
func TestWaitingInputCardCarriesRevisionAndDoesNotRenderSubmissionError(t *testing.T) {
	...
	link := TaskLink{ID: "LINK-0123456789ABCDEF", TaskKey: "0123456789abcdef0123", Title: "测试", ProjectName: "CodexAssistant", LinkState: "active", TurnState: "waiting_input", TurnOwner: "desktop", ActionRequired: "feishu", ActiveTurnID: "turn-1"}
