...
var legacySpecifications = []specification{
	...
	{path: "docs +create", risk: "write", action: "创建文档（仅冻结的纯文本 Markdown）", capabilities: "docs.shortcut.create docs.service.document.create", values: "title content doc-format parent-token parent-position", required: "content doc-format", targets: "parent-token parent-position", body: true},
	{path: "docs +update", risk: "write", action: "修改文档（仅冻结的纯文本 Markdown）", capabilities: "docs.shortcut.update docs.service.document.append", values: "doc command content doc-format pattern revision-id", required: "doc command content doc-format", targets: "doc", body: true},
...
var apiSpecifications = []apiSpecification{
	...
	{"POST", "/open-apis/drive/v1/files/:file-token/versions", specification{risk: "write", action: "创建文档版本", capabilities: "docbox.version", values: "params data", required: "data", body: true}},
