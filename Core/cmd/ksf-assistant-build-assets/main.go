...
func writeSBOM(repoRoot string) error {
	...
	packages := []spdxPackage{{SPDXID: "SPDXRef-Application", Name: "KSFAssistant", VersionInfo: "0.10.0-preview.1", DownloadLocation: "NOASSERTION", FilesAnalyzed: false, LicenseConcluded: "MIT", LicenseDeclared: "MIT"}}
